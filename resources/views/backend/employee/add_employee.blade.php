                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="name" class="form-control"  @error('name') is-invalid   @enderror placeholder="Enter first name">
                                                @error('name')
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="salary" class="form-control" @error('salary') is-invalid   @enderror placeholder="Enter salary">
                                                @error('salary')
                                                <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="vacation" class="form-control" @error('vacation') is-invalid   @enderror placeholder="Enter vacation">
                                                @error('vacation')
                                                <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
