                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="name" value="{{ $customer->name }}" class="form-control"  @error('name') is-invalid   @enderror placeholder="Enter Company Name">
                                                @error('name')
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="shopname" value="{{ $customer->shopname }}" class="form-control" @error('shopname') is-invalid   @enderror placeholder="Enter Industry Type">
                                                @error('shopname')
                                                <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="account_holder" value="{{ $customer->account_holder }}" class="form-control" @error('account_holder') is-invalid   @enderror placeholder="Enter Tax Identification Number (TIN)">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="bank_branch" value="{{ $customer->bank_branch }}" class="form-control" @error('bank_branch') is-invalid   @enderror placeholder="Enter Website">
                                                @error('bank_branch')
                                                <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
